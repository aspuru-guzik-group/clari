"""
(AL) Copied from:
https://github.com/jwohlwend/boltz/blob/cb04aeccdd480fd4db707f0bbafde538397fa2ac/src/boltz/model/optim/ema.py
"""
...
class EMA(Callback):
    ...
    def __init__(
        ...
        self._ema_weights: dict[str, Tensor] | None = None
        self._cur_step: int | None = None
        self._weights_buffer: dict[str, Tensor] | None = None
